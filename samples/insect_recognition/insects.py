...
class InsectPolygonsConfig(Config):
    ...
    BACKBONE = "resnet101" #tester resnet50
...
class InsectPolygonsDataset(utils.Dataset):
    ...
    def load_insect(self, dataset_dir, subset):
        ...
        self.add_class("insect", class_id_insect, "insect")
        ...
        # Add images
        self.add_images_from_class(annotations_abeille_mellifere, dataset_dir_abeille_mellifere, class_id_insect)
        self.add_images_from_class(annotations_bourdon_des_arbres, dataset_dir_bourdon_des_arbres, class_id_insect)
        self.add_images_from_class(annotations_anthophore_plumeuse, dataset_dir_anthophore_plumeuse, class_id_insect)
        self.add_images_from_class(annotations_bourdon_des_jardins, dataset_dir_bourdon_des_jardins, class_id_insect)
...
def train(model):
    """Train the model."""
    # Training dataset.
    dataset_train = InsectPolygonsDataset()
    dataset_train.load_insect(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = InsectPolygonsDataset()
...
if __name__ == '__main__':
    ...
    # Configurations
    if args.command == "train":
        config = InsectPolygonsConfig()
    else:
        class InferenceConfig(InsectPolygonsConfig):
